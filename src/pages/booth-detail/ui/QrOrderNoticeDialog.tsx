...
export const QrOrderNoticeDialog = ({
  ...
  return (
    <div className="absolute inset-0 z-40 bg-[rgba(28,28,28,0.5)] backdrop-blur-[24px]">
      <section
        aria-labelledby="qr-order-notice-title"
        aria-modal="true"
        className="absolute top-[200px] left-1/2 flex w-80 -translate-x-1/2 flex-col items-center gap-2.5 rounded-[36px] bg-[rgba(252,252,252,0.5)] px-7 py-8 backdrop-blur-[4px]"
        role="dialog"
      >
